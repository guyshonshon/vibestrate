...
<svg font-family="var(--font-sans)" viewBox="0 0 500 142" width="100%" style="max-width:720px;height:auto" role="img" aria-label="The review loop: an approved review moves on to merge_ready, but a changes-requested review sends the task back to executing, then back through validating into reviewing again.">
  <g fill="none" stroke="var(--line-strong)" stroke-width="1.25">
    <rect fill="var(--bg-200)" x="1" y="1" width="200" height="36" rx="8"/>
    <rect fill="var(--bg-200)" x="299" y="1" width="200" height="36" rx="8"/>
    <rect fill="var(--bg-200)" x="1" y="101" width="200" height="36" rx="8"/>
    <rect fill="var(--bg-200)" x="299" y="101" width="200" height="36" rx="8"/>
    <path d="M201 19H299M150 37V70H399V101M299 119H201M101 101V37"/>
  </g>
  <g fill="var(--fg-300)" stroke="none">
    <path d="M293 15 299 19 293 23Z"/>
    <path d="M395 95 399 101 403 95Z"/>
    <path d="M207 115 201 119 207 123Z"/>
    <path d="M97 43 101 37 105 43Z"/>
  </g>
  <g fill="var(--fg-100)" font-size="12" font-family="var(--font-mono)" text-anchor="middle">
    <text x="101" y="24">reviewing</text>
    <text x="399" y="24">merge_ready</text>
  </g>
  <g fill="var(--violet-soft)" font-size="11" text-anchor="middle">
    <text x="250" y="64">changes requested</text>
  </g>
  <g fill="var(--fg-100)" font-size="12" font-family="var(--font-mono)" text-anchor="middle">
    <text x="101" y="124">validating</text>
    <text x="399" y="124">executing</text>
  </g>
</svg>
