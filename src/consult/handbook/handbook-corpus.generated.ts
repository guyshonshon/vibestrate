...
export const HANDBOOK_CORPUS: HandbookCorpus = {
  ...
  "entries": [
    ...
    },
    {
      ...
      "titleTerms": "policy",
      "terms": "12 a activ add adopt advic advis an at author avoid avoid-em-dash block broken captur character choic cli concept confirm consult dash discard do draft em em-dash enforc english eyebrow fix from gat glanc hard hyphen id in it keep label list matcher merg migrat no no-em-dash no-eyebrow not one only option or owner owner-author owner-only past pend persona policy policy_advis policy_block preferenc project prompt propos recent reject remov review rul run s sect security see slip soft stay stop suggest supervisor surfac test the tier to ui use vib vibestrat vs what who would yml your",
