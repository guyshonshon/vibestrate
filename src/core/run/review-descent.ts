...
// includes active-content types like .svg that are fine to skip *test commands*
// for but must never skip *review*. And the protected-path
// floor applies on top: a protected prose file (a workflow
