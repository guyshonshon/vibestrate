  ...
  return (
    <>
      ...
      >
        ...
        {unread > 0 ? (
          <span className="mono absolute -top-1 -right-1 inline-flex h-4 min-w-[16px] items-center justify-center rounded-full bg-violet-soft px-1 text-meta font-semibold leading-none text-coal-900">
            {unread > 99 ? "99+" : unread}
          </span>
        ) : null}
      </button>
