  ...
  crews: {
    default: {
      roles: {
        ...
        executor: { seats: ["implementer"], profile: "claude-balanced", prompt: ".vibestrate/roles/executor.json", permissions: "code_write" },
        fixer: { seats: ["fixer"], profile: "claude-balanced", prompt: ".vibestrate/roles/fixer.json", permissions: "code_write" },
        reviewer: { seats: ["reviewer"], profile: "claude-balanced", prompt: ".vibestrate/roles/reviewer.json", permissions: "read_only" },
        verifier: { seats: ["verifier"], profile: "claude-balanced", prompt: ".vibestrate/roles/verifier.json", permissions: "read_only" },
      },
    },
  },
  defaultCrew: "default",
